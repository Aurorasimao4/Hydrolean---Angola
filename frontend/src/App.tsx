          ...
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <div className="flex items-center gap-4 ml-6 border-l border-gray-300/30 pl-6">
                <button className={`font-semibold transition-colors hover:text-brand-accent ${scrolled ? 'text-brand-primary' : 'text-white drop-shadow-sm'}`}>
                  Login
                </button>
                <button className={`px-6 py-2.5 rounded-full font-semibold transition-all shadow-md hover:shadow-lg ${scrolled ? 'bg-brand-primary text-white hover:bg-brand-secondary shadow-brand-primary/20' : 'bg-brand-accent text-white hover:bg-white hover:text-brand-accent shadow-black/10'}`}>
                  Cadastrar
                </button>
              </div>
            </div>
          ...
          <div className="bg-brand-white border-t border-gray-100 shadow-xl mt-2">
            <div className="px-4 py-6 space-y-4">
              ...
              <div className="pt-6 mt-4 border-t border-gray-100 flex flex-col gap-3">
                <button className="w-full text-brand-primary border-2 border-brand-primary/20 font-bold py-3.5 rounded-xl hover:bg-brand-primary/5 transition-colors">
                  Acessar Conta
                </button>
                <button className="w-full bg-brand-primary text-brand-white font-bold py-3.5 rounded-xl shadow-lg shadow-brand-primary/20">
                  Criar Conta Grátis
                </button>
              </div>
            </div>
            ...
            <div className="grid lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-7 text-center lg:text-left">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                  <button className="bg-brand-accent hover:bg-white text-brand-black px-8 py-4 rounded-xl font-bold text-lg transition-all shadow-[0_0_20px_rgba(41,167,217,0.4)] hover:shadow-[0_0_30px_rgba(255,255,255,0.6)] flex items-center justify-center gap-2 group">
                    Descobrir como funciona
                    <ArrowRight size={20} className="group-hover:translate-x-1 transition-transform" />
                  </button>
                  <button className="bg-white/10 text-white border border-white/30 hover:border-white hover:bg-white/20 px-8 py-4 rounded-xl font-bold text-lg transition-all flex items-center justify-center gap-2 backdrop-blur-md">
        ...
        < section className="py-24 bg-brand-primary relative overflow-hidden" >
          ...
          <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <button className="bg-brand-accent hover:bg-white text-brand-black px-10 py-5 rounded-full font-bold text-lg transition-all shadow-[0_0_20px_rgba(41,167,217,0.5)]">
          ...
          <div className="grid md:grid-cols-12 gap-12 mb-16">
            ...
            <div className="md:col-span-2 text-right">
              ...
              <ul className="space-y-4 font-light flex flex-col items-end">
                <li><button className="text-brand-accent hover:text-white transition-colors border border-brand-accent/30 rounded-full px-4 py-1">Login Seguro</button></li>
                <li><a href="#" className="hover:text-brand-accent transition-colors">Cadastro Prévio</a></li>
